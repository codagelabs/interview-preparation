...
type BulkIndexerService interface {
	ProductBulkIndexer(ctx context.Context, products []models.Product) (interface{}, *recomError.RECOMError)
}
type bulkIndexerService struct {
...
func (b bulkIndexerService) getBatchCount(totalProducts int) int {
...
func (b bulkIndexerService) BulkIndexer(ctx context.Context, products []models.Product, indexName string) (interface{}, *recomError.RECOMError) {
...
func NewBulkIndexer(bulkIndexerRepo repository.BulkDocumentIndexer, bulkIndexerConfig configurations.BulkIndexerConfig, elasticSearchErrorInterceptor recomError.ElasticSearchErrorInterceptor) ProductBulkIndexerService {
